                    ...
                    <div>
                        ...
                        <% if (session.getAttribute("Patient_list") == null && session.getAttribute("statistics") == null) { %>
                            <div class='row row justify-content-md-center'>
                                ...
                                <div class='container2 col-3 border border-primary m-1   text-center'>
                                    ...
                                    <div class = "form-group">  
                                        <input name="statisticsCal" type="checkbox" id="statisticsCal">
                                        <label for="statisticsCal" >Permisos ADMIN para Estadisticas</label>
                        ...
                        <%}else{ %>
                            ...
                            <div class="container-fluid">
                                ...
                                <h6>Condición 2: ${empty keyWord2 ? '' : keyWord2}</h6>
